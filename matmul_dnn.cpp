...
int main() {
    ...
    dnnl::memory::dims bias_dims = {matrix_size};
    ...
    dnnl::memory bias_mem({bias_dims, dnnl::memory::data_type::f32, dnnl::memory::format_tag::a}, eng);
    ...
    dnnl::matmul::primitive_desc matmul_pd({src_dims, dnnl::memory::data_type::f32, dnnl::memory::format_tag::abc}, 
                                           {weight_dims, dnnl::memory::data_type::f32, dnnl::memory::format_tag::abc}, 
                                           {bias_dims, dnnl::memory::data_type::f32, dnnl::memory::format_tag::a}, 
                                           {dst_dims, dnnl::memory::data_type::f32, dnnl::memory::format_tag::abc}, eng);
